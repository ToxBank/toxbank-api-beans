...
public class InvestigationIOTest extends AbstractIOClassTest<Investigation> {
  ...
  public static final String ALT_BII_TEST_CASE_ACCESSION_ID = "BII-I-1";
  ...
  public static void verifyBiiInvestigation(Investigation i) throws Throwable {
    TestCase.assertTrue(
        "Should have correct accession id",
        BII_TEST_CASE_ACCESSION_ID.equals(i.getAccessionId()) ||
        ALT_BII_TEST_CASE_ACCESSION_ID.equals(i.getAccessionId())
        );
